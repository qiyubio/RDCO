...
#coverageBed -b ${1}.sort.bed -a canFam3_100kb_new.genome_${2} >${1}_100kb.bedgraph
macs2 callpeak -t ${1}.sort.bed --bw=1000 --gsize=${3} -q=0.01 --slocal=2000 --llocal=10000 -m 3 30 --name=${1}_macs2 2>${1}_macs2.out

grep -P ${2}"\t" ${4}|cut -f1-3 >dog1_peak_${2}
...
intersectBed -a ${1}_macs2_peaks.xls.bed -b dog1_peak_${2} -u >${1}_overlap.bed
intersectBed -a ${1}_macs2_peaks.xls.bed -b dog1_peak_${2} -v >${1}_nonoverlap.bed
intersectBed -b ${1}_macs2_peaks.xls.bed -a dog1_peak_${2} -u >${1}_peak_at.bed
