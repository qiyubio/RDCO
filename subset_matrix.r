...
defplot2<-function(file,chr=NA,name=NA){
  ...
  # homo1<-matrix1[which(matrix1$x<=center
  #                      & matrix1$y >=center), ]
  # homo1m<-convertm(homo1)
  # homo2<-matrix1[which(matrix1$x>=center
  #                      & matrix1$y<=center), ]
  # homo2m<-convertm(homo2)
  # homo3<-matrix1[which(matrix1$x<center
  #                      & matrix1$y<center), ]
  # homo3m<-convertm(homo3)
  # homo4<-matrix1[which(matrix1$x>center
  #                      & matrix1$y>center), ]
  # homo4m<-convertm(homo4)
