...
if (genome=="gg5"){
  genomelength<-read.table("/home/qiyu/data/genome/galGal5/galGal5.genome.new")
}
...
if (!is.na(winsize)){
  ...
  fnew<-rbind(fnew,new)
    ...
    write.table(fnew,row.names=F,file=paste(title,"_",genome,"_",winsize,"_fragment1.out",sep=""))
    ...
    ggsave(plot=d,filename=paste(title,"_",genome,"_",winsize,"fragment_pos_per_chr1.png", sep=''),height=10,width=16)
    ...
    d3=ggplot(fnew,aes(x=xp,y=yp,color=chr))+
      ...
      scale_y_log10(labels = trans_format("log10", math_format(10^.x)))+
      annotation_logticks(sides="lb")
    ggsave(plot=d3,filename=paste(title,"_",genome,"_",winsize,"fragment_pos_per_chr_noXY1.png", sep=''),height=10,width=16)
...
plotIntraDistnew(homo,winsize=1000,title=title,genome=genome)
...
readfile("/home/yuqi/Downloads/GSM2745853_13NOV15_PE50_C7M45AC_JHGHiC-DT40CDK1as-WT-20151009-5m-R1_galGal5.validPair.txt.gz_count.txt",title="5min",genome="gg5")
readfile("/home/yuqi/Downloads/GSM2745854_13NOV15_PE50_C7M45AC_JHGHiC-DT40CDK1as-WT-20151009-7m-R1_galGal5.validPair.txt.gz_count.txt",title="7min",genome="gg5")
readfile("/home/yuqi/Downloads/GSM2745857_26AUG15_PE50_AC79FYAC_JHGHiC-DT40CDK1as-WT-20150603-s15m-R1_galGal5.validPair.txt.gz_count.txt",title="15min",genome="gg5")
readfile("/home/yuqi/Downloads/GSM2745858_26AUG15_PE50_AC79FYAC_JHGHiC-DT40CDK1as-WT-20150603-s30m-R1_galGal5.validPair.txt.gz_count.txt",title="30min",genome="gg5")
readfile("/home/yuqi/Downloads/GSM2745859_26AUG15_PE50_AC79FYAC_JHGHiC-DT40CDK1as-WT-20150603-s60m-R1_galGal5.validPair.txt.gz_count.txt",title="60min",genome="gg5")
readfile("/home/yuqi/Downloads/GSM2745855_13NOV15_PE50_C7M45AC_JHGHiC-DT40CDK1as-WT-20151009-10m-R1_galGal5.validPair.txt.gz_count.txt",title="10min",genome="gg5")
